...
class Restorex1024:
    ...
    def postprocess(self, img):
        ...
        return (
            torch.clip(img, -1, 1)[0].permute(1, 2, 0).cpu().numpy()[..., ::-1] + 1
        ) * 127.5


# if __name__ == "__main__":
#     model = Restorex1024(
#         "/home/ubuntu/Desktop/eugene/GFPGAN/experiments/pretrained_models/GFPGANx1024.pth"
#     )

#     base = "/home/ubuntu/Desktop/eugene/GFPGAN/GFPGAN-1024/inputs"

#     fn = lambda x: [os.path.join(x, f) for f in os.listdir(x)]

#     img_paths = fn(base)

#     save = "/home/ubuntu/Desktop/eugene/GFPGAN/GFPGAN-1024/results"
